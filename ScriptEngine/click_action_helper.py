...
class ClickActionHelper:
    ...
    @staticmethod
    def draw_click(screenshot_bgr, point_choice, logs_path, log_level='info', logs_prefix='click_location'):
        ...
        if log_level == 'info':
            cv2.imwrite(logs_path + logs_prefix + '-' + str(point_choice[0]) + '-' + str(point_choice[1]) + '.png', screenshot_bgr)