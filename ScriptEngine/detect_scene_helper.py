...
class DetectSceneHelper:
    ...
    def get_match(
        ...
        if needs_rescale:
            ...
            script_logger.log('resized input : ', screencap_im_bgr.shape, scene_screencap_mask.shape)
        ...
        script_logger.log('output_cropping', output_cropping)
        ...
        script_logger.log('match_img_bgr.shape ', match_img_bgr.shape)
